...
export default function JoinUs() {
  ...
  return (
    <div className="w-full md:w-3/5 min-h-[300px] bg-gradient-to-r from-slate-800 to-slate-700 p-6 md:p-24 flex flex-col justify-center items-center">
      <h2 className="text-white text-3xl md:text-4xl mb-6 mt-4 sm:mt-0">Join the Club</h2>
      <p className="text-white text-base md:text-lg text-center max-w-[90%] mb-8">
      ...
      <div className="flex flex-row gap-4">
        <Button
          className="bg-white text-slate-700 hover:bg-slate-200 px-6 py-3"
          size="lg"
        ...
        <Button
          as={Link}
          className="bg-sky-500 text-white hover:bg-sky-600 px-6 py-3"
          size="lg"
          href="/register"
        >
          Join The Club
